  ...
  <div
    ...
    <div class="meta">
      <div class="description">
        <slot></slot>
        <el-tooltip effect="dark" content="Run this demo on jsfiddle.net" placement="right">
          <el-button size="small" type="primary" @click="goJsfiddle">Try it!</el-button>
        </el-tooltip>
      </div>
    ...
    methods: {
      goJsfiddle() {
        ...
        const resourcesTpl = '<scr' + 'ipt src="//unpkg.com/vue/dist/vue.js"></scr' + 'ipt>' +
          '\n<scr' + 'ipt src="//unpkg.com/advance-ui/lib/index.js"></scr' + 'ipt>';
        let jsTpl = (script || '').replace(/export default/, 'var Main =').trim();
        let htmlTpl = `${resourcesTpl}\n<div id="app">\n${html.trim()}\n</div>`;
        let cssTpl = `@import url("//unpkg.com/advance-ui/lib/theme-ai/index.css");\n${(style || '').trim()}\n`;
        jsTpl = jsTpl
