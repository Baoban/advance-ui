...
import locale from 'advance-ui/lib/locale/lang/en'
...
import lang from 'advance-ui/lib/locale/lang/en'
import locale from 'advance-ui/lib/locale'
...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/advance-ui[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]zh-CN/, 'advance-ui/lib/locale/lang/en')
  ]
}
```
...
import Element from 'advance-ui'
import enLocale from 'advance-ui/lib/locale/lang/en'
import zhLocale from 'advance-ui/lib/locale/lang/zh-CN'
